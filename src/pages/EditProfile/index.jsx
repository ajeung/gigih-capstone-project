      ...
      <div className="form__wrapper">
        ...
        <div className="form__card">
          ...
          <div className="data__user">
            <form>
              <label for="nama" className="nama">
                Nama
              </label>
              <input id="nama" type="text"></input>
              <br></br>
              <label for="ttl" className="ttl">
                Tanggal Lahir
              </label>
              <input id="ttl" type="date"></input>
              <br></br>
              <label for="jenisKelamin" className="jenisKelamin">
                Jenis Kelamin
              </label>
              <input id="jenisKelamin" type="text"></input>
              <br></br>
              <label for="beratB" className="beratB">
                Berat Badan
              </label>
              <input id="beratB" type="text"></input>
              <br></br>
              <label for="tinggiB" className="tinggiB">
                Tinggi Badan
              </label>
